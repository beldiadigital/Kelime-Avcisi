                        ...
                        child: Column(
                          children: [
                            _buildModernButton(
                              ...
                              title: "KOLAY",
                              subtitle:
                                  "${LevelProgress.getCompletedCount(GameDifficulty.kolay)}/50 Tamamlandı",
                              gradient: const [
                                Color(0xFF4facfe),
                                Color(0xFF00f2fe),
                              ],
                            ...
                            _buildModernButton(
                              ...
                              title: "ORTA",
                              subtitle:
                                  "${LevelProgress.getCompletedCount(GameDifficulty.orta)}/50 Tamamlandı",
                              gradient: const [
                                Color(0xFFfa709a),
                                Color(0xFFfee140),
                              ],
                            ...
                            _buildModernButton(
                              ...
                              title: "ZOR",
                              subtitle:
                                  "${LevelProgress.getCompletedCount(GameDifficulty.zor)}/50 Tamamlandı",
                              gradient: const [
                                Color(0xFFf857a6),
                                Color(0xFFff5858),
                              ],
